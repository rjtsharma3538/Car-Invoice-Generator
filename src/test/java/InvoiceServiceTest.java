...
public class InvoiceServiceTest {
    ...
    public void testCalculateFare() {
        ...
        double fare = cabInvoiceGenerator.CalculateFare(5, 15,"normal");
        assertEquals(65.0, fare);
    }

    @Test
    public void minimumFare() {
        double fare = cabInvoiceGenerator.CalculateFare(0.1, 1,"normal");
    ...
    @Test
    public void summary() {
        Ride[] rides = { new Ride(2, 5,"normal"), new Ride(0.1, 1,"premium") };
    ...
    public void invoice_service(){
        String user1 = "abc";
        cabInvoiceGenerator.addRides(user1, new Ride(10,6,"normal"));
        cabInvoiceGenerator.addRides(user1, new Ride(0.2,1,"premium"));

        InvoiceSummary actual = cabInvoiceGenerator.getInvoiceReport(user1);
        InvoiceSummary expected = new InvoiceSummary(2, 126);
